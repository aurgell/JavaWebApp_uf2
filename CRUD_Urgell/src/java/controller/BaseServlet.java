...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected String displayAllForm = null;
    ...
    protected String listServlet = null;
    protected String logoutServlet = null;
    protected String loginServlet = null;
    ...
    public void init() {
        ...
        displayAllForm = context.getInitParameter("displayAllForm");
        ...
        listServlet = context.getInitParameter("listServlet");
        updateServlet = context.getInitParameter("updateServlet");
        loginServlet = context.getInitParameter("loginServlet");
        logoutServlet = context.getInitParameter("logoutServlet");
